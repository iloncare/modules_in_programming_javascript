...
function displayNotes() {
  contentClear();
  contentEle.innerHTML = "Display Notes";
  writeBlocks(contentEle);
}

function addNotes() {
  contentClear();
  var addNotesEle = document.createElement("div");
  addNotesEle.innerHTML = "Add Notes Here";
  contentEle.appendChild(addNotesEle);
}
...
function writeBlocks(element) {
  ...
  var array = [
    ...
    {
      text:
        "I am Groot. I am Groot. I am Groot. I am Groot. I am Groot. I am Groot. I am Groot. I am Groot. We are Groot. I am Groot. We are Groot. I am Groot. We are Groot. I am Groot. I am Groot. I am Groot. I am Groot. We are Groot. I am Groot. I am Groot. I am Groot. We are Groot. We are Groot. We are Groot. I am Groot. ",
      importance: 4
    },
    {
      text:
  ...
  for (var i = 0; i < array.length; i++) {
    if (array[i].importance === 5) {
      var itmEle = document.createElement("div");
      itmEle.innerHTML = array[i].text;
